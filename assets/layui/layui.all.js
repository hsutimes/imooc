...
!function (e, t) {
    ...
    })) : "function" == typeof define && define.amd ? define(["js/jquery"], function () {
...
layui.define("jquery", function (i) {
    ...
    s.prototype.set = function (i) {
        ...
        return s[0] ? s.before(c) : n.append(c), o.append('<div class="layui-tab-item">' + (a.content || "") + "</div>"), f.hideTabMore(!0), f.tabAuto(), this
        ...
        i = i || {}, b.on("click", i.headerElem, function (a) {
            var e = t(this).index();
    ...
    var o = ".layui-nav", c = "layui-nav-item", r = "layui-nav-bar", u = "layui-nav-tree", d = "layui-nav-child",
        h = "layui-nav-more", y = "layui-anim layui-anim-upbit", f = {
            tabClick: function (i, a, s, o) {
                ...
                n.hasClass(l) && (n.next()[0] ? f.tabClick.call(n.next()[0], null, s + 1) : n.prev()[0] && f.tabClick.call(n.prev()[0], null, s - 1)), n.remove(), c.eq(s).remove(), setTimeout(function () {
                    f.tabAuto()
                ...
                t(".layui-tab").each(function () {
                    ...
                    if (n === window && 8 != a.ie && f.hideTabMore(!0), s.attr("lay-allowClose") && o.find("li").each(function () {
                            var i = t(this);
                            if (!i.find("." + l)[0]) {
    ...
    s.prototype.init = function (i, e) {
        var l = function () {
            ...
            tab: function () {
                ...
                var i = 200, e = {}, s = {}, p = {}, b = function (l, o, c) {
                    var r = t(this), f = r.find("." + d);
                    o.hasClass(u) ? l.css({
                        top: r.position().top,
                    ...
                    }, a.ie && a.ie < 10 ? 0 : i), clearTimeout(p[c]), "block" === f.css("display") && clearTimeout(s[c]), s[c] = setTimeout(function () {
                        f.addClass(n), r.find("." + h).addClass(h + "d")
                    }, 300))
                };
                t(o + l).each(function (a) {
                    var l = t(this), o = t('<span class="' + r + '"></span>'), y = l.find("." + c);
                    l.find("." + r)[0] || (l.append(o), y.on("mouseenter", function () {
                        b.call(this, o, l, a)
                        ...
                        i.off("click", f.clickThis).on("click", f.clickThis), i.children("a").off("click", f.showChild).on("click", f.showChild), a.children("dd").off("click", f.clickChild).on("click", f.clickChild)
                    })
                })
            }, breadcrumb: function () {
                ...
                t("." + i + l).each(function () {
                    ...
                    i.each(function () {
                        ...
                        a.find(".layui-colla-icon").remove(), a.append('<i class="layui-icon layui-colla-icon">' + (l ? "&#xe602;" : "&#xe61a;") + "</i>"), a.off("click", f.collapse).on("click", f.collapse)
                    })
                })
            }
        };
...
layui.define(["laytpl", "laypage", "layer", "form"], function (e) {
    ...
    var t = layui.$, i = layui.laytpl, a = layui.laypage, l = layui.layer, n = layui.form, o = layui.hint(),
        ...
        }, s = "table", u = ".layui-table", f = "layui-hide", h = "layui-none", y = "layui-table-view",
        p = ".layui-table-header", m = ".layui-table-body", v = ".layui-table-main", g = ".layui-table-fixed",
        x = ".layui-table-fixed-l", b = ".layui-table-fixed-r", k = ".layui-table-tool", C = ".layui-table-sort",
        w = "layui-table-edit", N = "layui-table-hover", z = function (e) {
        ...
        L = t(window), S = t(document), H = function (e) {
            var i = this;
    ...
    H.prototype.config = {limit: 30, loading: !0}, H.prototype.render = function (e) {
        ...
        var c = this, s = c.config, u = e[s.response.dataName] || [], f = [], y = [], p = [], m = function () {
        ...
        u.on("mousemove", function (e) {
            ...
            var i, l = t(this), n = l.find(C), o = n.attr("lay-sort");
            ...
            if (!e.data("off")) {
                ...
                Math.round(i.prop("scrollWidth")) > Math.round(i.outerWidth()) && (a.tipsIndex = l.tips(['<div class="layui-table-tips-main" style="margin-top: -' + (i.height() + 16) + "px;" + function () {
                ...
                }() + '">', i.html(), "</div>", '<i class="layui-icon layui-table-tips-customer">&#x1006;</i>'].join(""), i[0], {
                    tips: [3, ""],
                    time: -1,
                    anim: -1,
                    ...
                    success: function (e, t) {
                        e.find(".layui-table-tips-customer").on("click", function () {
                            l.close(t)
                        })
                    }
                }))
...
layui.define("jquery", function (e) {
    ...
    var t = layui.$, o = {
        fixbar: function (e) {
            var o, i, a = "layui-fixbar", l = "layui-fixbar-top", n = t(document), r = t("body");
            e = t.extend({showHeight: 200}, e), e.bar1 = e.bar1 === !0 ? "&#xe606;" : e.bar1, e.bar2 = e.bar2 === !0 ? "&#xe607;" : e.bar2, e.bgcolor = e.bgcolor ? "background-color:" + e.bgcolor : "";
            var c = [e.bar1, e.bar2, "&#xe604;"],
                u = t(['<ul class="' + a + '">', e.bar1 ? '<li class="layui-icon" lay-type="bar1" style="' + e.bgcolor + '">' + c[0] + "</li>" : "", e.bar2 ? '<li class="layui-icon" lay-type="bar2" style="' + e.bgcolor + '">' + c[1] + "</li>" : "", '<li class="layui-icon ' + l + '" lay-type="top" style="' + e.bgcolor + '">' + c[2] + "</li>", "</ul>"].join("")),
                s = u.find("." + l), b = function () {
                    var t = n.scrollTop();
                    t >= e.showHeight ? o || (s.show(), o = 1) : o && (s.hide(), o = 0)
                };
            t("." + a)[0] || ("object" == typeof e.css && u.css(e.css), r.append(u), b(), u.find("li").on("click", function () {
                var o = t(this), i = o.attr("lay-type");
            ...
            var i = this, a = "function" == typeof t, l = new Date(e).getTime(),
                n = new Date(!t || a ? (new Date).getTime() : t).getTime(), r = l - n,
            ...
            var o = [[], []], i = (new Date).getTime() - new Date(e).getTime();
            return i > 6912e5 ? (i = new Date(e), o[0][0] = i.getFullYear(), o[0][1] = i.getMonth() + 1, o[0][2] = i.getDate(), t || (o[1][0] = i.getHours(), o[1][1] = i.getMinutes(), o[1][2] = i.getSeconds()), o[0].join("-") + " " + o[1].join(":")) : i >= 864e5 ? (i / 1e3 / 60 / 60 / 24 | 0) + "天前" : i >= 36e5 ? (i / 1e3 / 60 / 60 | 0) + "小时前" : i >= 12e4 ? (i / 1e3 / 60 | 0) + "分钟前" : i < 0 ? "未来" : "刚刚"
        }
    };
    e("util", o)
});
